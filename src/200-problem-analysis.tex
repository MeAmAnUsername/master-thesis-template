...
Language projects include ESV files that specify editor configuration settings like syntax highlighting (which is also autogenerated, but this allows a language developer to customize it) and editor actions.

Finally, a \inlinecode{metaborg.yaml} file denotes a directory as a language project.
This file specifies project configurations like what SDF3 compiler to use.
