...
Spoofax editors and actions have many dependencies \question{Change to / include a dependency graph?}
\begin{itemize}
  ...
  \begin{itemize}
    ...
    This produces an ATerm. \question{not explained yet, refer to future section or use AST for now?}
